...
namespace timetable::domain::assignment {
    ...
    /**
     * @brief Retain one candidate prefix in the paper node-local set C_y.
     *
     * This is the algebraic retention operation from the paper's branch-and-
     ...
     */
    [[nodiscard]] mathfp::Expected<PaperConnectionRetentionDecision>
