...
namespace timetable::domain::assignment::runtime {
    ...
    struct SearchBatchEnvironment final {
    ...
    struct SearchBatchState final {
        SearchBatchState() = default;
        SearchBatchState(const SearchBatchState&) = delete;
        SearchBatchState& operator=(const SearchBatchState&) = delete;
        SearchBatchState(SearchBatchState&& other) noexcept;
        SearchBatchState& operator=(SearchBatchState&& other) noexcept;
        ...
        [[nodiscard]] SearchBatchContext context(
            const SearchBatchEnvironment& environment
        );
    };

    [[nodiscard]] mathfp::Expected<SearchBatchState> prepare_search_batch_state(
        const SearchBatchEnvironment& environment
    );
